 ...
 * 归并排序
 *
 * ForkJoinTask 的子类 RecursiveAction ：用于没有返回结果的任务
 *
 * 线性算法 与 ForkJoin 对比
 *
 */
public class MergeSortMain {
    ...
    public static void main(String[] args) {
        int[] arrayToSort = Utils.buildRandomIntArray(20_000_000);
        ...
        int[] arrayToSortSingleThread = Utils.buildRandomIntArray(20_000_000);
